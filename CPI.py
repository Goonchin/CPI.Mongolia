...
if selected_column == "Alcohol And Tobacco":
    ...
    description = "The recorded data starts in 2006-2022. Unlike the rest of the charts, communications flucuated much differently. It's shown that 2008-2011 there was a huge increase in price, which is probably due to growth in communications, as well as new laws being introduced concerning the information technology field. The price of communication in Mongolia over the next 36 months will continue to stay stagnant due to costs remaining relatively similar throughout the years."
